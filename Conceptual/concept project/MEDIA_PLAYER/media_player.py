...
class Video(Media, Description):
    ...
    def play(self):
        print(f"Playin Video {self.title}")
...
class AudioBook(Media, Description):
    ...
    def play(self):
        print(f"Playin audioBook {self.title}")
...
library = Library()
music1 = Music('Music Track 1', "3.43", "Authon : Phitron")
music2 = Music('Music Track 2', "5.64", "Authon : Phitron")
video = Video("Video Track 1", "45.24", "Artist : T-series")
audio = AudioBook("Audio track 1", '30', 'Author : Programming Hero')
...
free_user = FreeUser("Upal")
premium_user = PremiumUser("pathor")
